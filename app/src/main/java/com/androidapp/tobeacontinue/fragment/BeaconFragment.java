...
public class BeaconFragment extends Fragment {
    ...
    //ImageButton house;
    ImageView house,outside,school,cafeteria,extra;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        house = (ImageView) view.findViewById(R.id.houseButton);
        outside = (ImageView) view.findViewById(R.id.outsideButton);
        school = (ImageView) view.findViewById(R.id.schoolButton);
        cafeteria = (ImageView) view.findViewById(R.id.cafeteriaButton);        //fragment_home2.xml파일에 있는 5개의 버튼 중 장소 버튼 4개를 객체화

        extra = (ImageView) view.findViewById(R.id.addButton);
